...
setwd( './Alignments/BLAST/BLAST6_Plastid2Nuc_results'  )

files <- list.files(path =  './Alignments/BLAST/BLAST6_Plastid2Nuc_results' , pattern = "*.out")  # BLAST results (alignments in tabular format)
...
save( fit_exp_norm_mixEM, fit_exp_mixEM,  fit_unimodal_mixEM ,  fit_bimodal_mixEM , 
      Best_fit, Best_fit_deltaBIC , file = "Fitted_Mixtures_NUPTs_K_0.RData")
...
load( './Mixture_model_analysis/Fitted_Mixtures_NUPTs_K_0.RData' ) # Models fitted to the 30-species dataset 
...
save( list_fit_exp_norm_mixEM, list_fit_exp_mixEM,  list_fit_unimodal_mixEM ,  list_fit_bimodal_mixEM , 
      list_Best_fit, list_Best_fit_deltaBIC , file = './Mixture_model_analysis/Fitted_Mixtures_NUPTs_K_list_replicates.RData' )
...
load(  './Mixture_model_analysis/Fitted_Mixtures_NUPTs_K_list_replicates.RData' )  # R objects 
...
### Mixture of exponential and Guassian
...
#### 5.2. Bimodal (Two-Gaussian) model
...
#### 5.5. Unimodal (One Gaussian) model
